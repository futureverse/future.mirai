...
- [`mirai_cluster()`](https://future.mirai.futureverse.org/reference/mirai_cluster.md)
  : Mirai-based cluster futures
- [`mirai_multisession()`](https://future.mirai.futureverse.org/reference/mirai_multisession.md)
